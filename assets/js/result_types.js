...
$(document).ready(function () {
    ...
    $(document).on('click', '.add-results-mdl', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#add-result').modal({backdrop: 'static', keyboard: false});
                _this.find('i').remove();
    ...
    $(document).on('click', '.edit-results-mdl', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#results-modals').html(data);
                $('#edit-result').modal({backdrop: 'static', keyboard: false});

...
$(document).ready(function () {
    ...
    $(document).on('click', '.add-post-mdl', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#add-post').modal({backdrop: 'static', keyboard: false});
                _this.find('i').remove();
    ...
    $(document).on('click', '.edit-post-mdl', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#results-modals').html(data);
                $('#edit-post').modal({backdrop: 'static', keyboard: false});

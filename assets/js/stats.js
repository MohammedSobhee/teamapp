...
$(document).ready(function () {
    ...
    $(document).on('click', '.add-stats-mdl', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#add-stats').modal({backdrop: 'static', keyboard: false});
                _this.find('i').remove();
    ...
    $(document).on('click', '.edit-stats-mdl', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#results-modals').html(data);
                $('#edit-stats').modal({backdrop: 'static', keyboard: false});

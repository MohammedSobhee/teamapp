...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__head">
            ...
            <div class="m-portlet__head-tools">
                <a href="{{url(admin_settings_url().'/stats/create')}}"
                   class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air add-stats-mdl">
                    احصائية جديدة
                </a>
            </div>
        </div>
        <div class="m-portlet__body">
            ...
            <!--begin: Datatable -->
            <table class="m-datatable" id="stats_table" width="100%">
            </table>
    ...
    @push('js')
        ...
        <script src="{{url('/')}}/assets/js/stats.js" type="text/javascript"></script>
    @endpush
@stop

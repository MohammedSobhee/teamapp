<div class="modal fade" id="edit-admin" role="dialog" aria-labelledby="exampleModalCenterTitle">
                            ...
                            <div class="col-6">
                                <div class="form-group m-form__group input-group">
                                    <input type="text" class="form-control m-input" name="username"
                                           placeholder="إسم المستخدم" value="{{$admin->username}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group m-form__group input-group">
                                    <input type="text" class="form-control m-input" name="mobile"
                                           placeholder="رقم الجوال" value="{{$admin->mobile}}">
                                </div>
                            </div>

...
<script src="{{url('/')}}/assets/vendors/toastr/toastr.min.js" type="text/javascript"></script>
<script src="{{url('/')}}/assets/vendors/toastr/sweetalert2.min.js" type="text/javascript"></script>

<script src="{{url('/')}}/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js"

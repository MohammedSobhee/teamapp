        ...
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
                        <img src="<?php echo e(url('/')); ?>/assets/app/media/img/logos/logo-1.png">
                    </a>
                </div>
                <div class="m-login__signin">
                    <div class="m-login__head">
                        <h3 class="m-login__title">الدخول للوحة التحكم</h3>
                    </div>
                    <?php echo Form::open(['method'=>'POST','url'=>route('admin.login.submit'),'class'=>'m-login__form m-form']); ?>

                    <div class="form-group m-form__group">
                        <input class="form-control m-input" type="text" placeholder="البريد الالكتروني" name="email"
                               autocomplete="off">
                    </div>
                    <div class="form-group m-form__group">
                ...
                <div class="m-login__forget-password">
                    <div class="m-login__head">
                        ...
                        <div class="m-login__desc">أدخل بريدك الالكتروني لاعادة تعيين كلمة المرور:</div>
                    </div>
                        <?php echo Form::open(['method'=>'post','url'=>route('admin.password.email'),'class'=>'m-login__form m-form']); ?>
                        ...
                        <div class="m-login__form-action">
                            ...
                            <button id="m_login_forget_password_cancel"
                                    class="btn btn-outline-focus m-btn m-btn--pill m-btn--custom m-login__btn">الغاء
                            </button>
                        </div>
                    <?php echo Form::close(); ?>
...
<?php /**PATH /home/macrbynj/public_html/teamapp/resources/views/admin/login.blade.php ENDPATH**/ ?>